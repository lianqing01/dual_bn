...
class _NormBase(Module):
    """Common base of _InstanceNorm and _BatchNorm_n1_"""
    _version = 2
...
class _BatchNorm_n1_(_NormBase):

    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True,
                 track_running_stats=True):
        super(_BatchNorm_n1_, self).__init__(
        ...
        if self.training:
            ...
            if self.training and self.track_running_stats:
                ...
                if self.sample_noise is True:
                    ...
                    output = (input - _unsqueeze_ft(mean * noise_mean)) * _unsqueeze_ft(torch.sqrt(1 / ((std * noise_var)**2 + self.eps))  * self.weight) \
...
class BatchNorm_n1_1d(_BatchNorm_n1_):
    ...
    Examples::
        ...
        >>> m = nn.BatchNorm_n1_1d(100)
        >>> # Without Learnable Parameters
        >>> m = nn.BatchNorm_n1_1d(100, affine=False)
...
class BatchNorm_n1_2d(_BatchNorm_n1_):
    ...
    Examples::
        ...
        >>> # With Learnable Parameters
        >>> m = nn.BatchNorm_n1_2d(100)
        >>> # Without Learnable Parameters
        >>> m = nn.BatchNorm_n1_2d(100, affine=False)
...
class BatchNorm_n1_3d(_BatchNorm_n1_):
    ...
    Examples::
        ...
        >>> # With Learnable Parameters
        >>> m = nn.BatchNorm_n1_3d(100)
        >>> # Without Learnable Parameters
        >>> m = nn.BatchNorm_n1_3d(100, affine=False)
