...
parser.add_argument('--schedule', default=[50,100])
...
if args.norm_layer is not None and args.norm_layer != 'False':
    ...
    elif args.norm_layer == 'cbn_gamma_noise':
        norm_layer = models.__dict__['Constraint_Norm_gamma_noise2d']
    elif args.norm_layer == 'cbn_aug':
        norm_layer = models.__dict__['Constraint_Norm_aug2d']
    else:
        norm_layer = None
net = models.__dict__[args.model](num_classes=num_classes, norm_layer=norm_layer)
if args.norm_layer == 'cbn_aug':
    for m in net.modules():
        if isinstance(m, models.__dict__['Constraint_Lagrangian_aug']):
            m.roi = args.aug_roi
if use_cuda:
    net.cuda()
